...
const dicionarioTermos = [
    ...
    // === SIGLAS E ABREVIAÇÕES MÉDICAS ===
    { term: 'IAM', simple: 'Infarto Agudo do Miocárdio (ataque cardíaco)', detail: 'O músculo do coração morre por falta de sangue quando uma artéria coronária entope. Emergência — cada minuto sem tratamento = mais coração perdido.' },
    { term: 'IAMCSST', simple: 'Infarto com Supra de ST (tipo mais grave de infarto)', detail: 'Infarto onde a artéria está COMPLETAMENTE bloqueada. Aparece como elevação do segmento ST no eletrocardiograma. Requer cateterismo em < 90 min.' },
    { term: 'AVC', simple: 'Acidente Vascular Cerebral (derrame)', detail: 'O cérebro para de receber sangue (isquêmico = entupiu) ou sangra dentro (hemorrágico = rompeu). Causa paralisia, fala enrolada, perda de visão.' },
    { term: 'TEP', simple: 'Tromboembolismo Pulmonar (coágulo no pulmão)', detail: 'Um coágulo (geralmente da perna) viaja pelo sangue e entope uma artéria do pulmão. Causa falta de ar súbita e pode matar.' },
    { term: 'TVP', simple: 'Trombose Venosa Profunda (coágulo na perna)', detail: 'Coágulo de sangue numa veia profunda da perna. Perna fica inchada, vermelha e dolorida. Perigo: pode soltar e ir pro pulmão (TEP).' },
    { term: 'IOT', simple: 'Intubação Orotraqueal (tubo na garganta para respirar)', detail: 'Procedimento de emergência onde um tubo é colocado na traqueia para a pessoa respirar com ajuda de máquina. Feito quando paciente não respira sozinho.' },
    { term: 'AAS', simple: 'Ácido Acetilsalicílico (Aspirina)', detail: 'Medicamento que "afina o sangue" impedindo as plaquetas de grudar. Usado no infarto, AVC e prevenção de coágulos.' },
    { term: 'VNI', simple: 'Ventilação Não-Invasiva (máscara que ajuda a respirar)', detail: 'Máscara que empurra ar para os pulmões sem precisar de tubo na garganta. Usada em edema pulmonar, DPOC, insuficiência respiratória.' },
    { term: 'CPAP', simple: 'Pressão Positiva Contínua nas Vias Aéreas', detail: 'Tipo de VNI que mantém pressão constante para impedir que os alvéolos pulmonares fechem. Usado em EAP e apneia do sono.' },
    { term: 'EAP', simple: 'Edema Agudo de Pulmão (pulmão cheio de líquido)', detail: 'Os pulmões se enchem de líquido por falência do coração. Causa falta de ar extrema, espuma rosada pela boca. Emergência.' },
    { term: 'VM', simple: 'Ventilação Mecânica (respirador/máquina de respirar)', detail: 'Máquina de UTI que respira pelo paciente quando ele não consegue sozinho. Conectada pelo tubo orotraqueal.' },
    { term: 'UTI', simple: 'Unidade de Terapia Intensiva', detail: 'Setor do hospital para pacientes em estado grave, com monitoramento 24h, aparelhos de suporte vital e equipe especializada.' },
    { term: 'ECG', simple: 'Eletrocardiograma (exame que registra a atividade elétrica do coração)', detail: 'Exame rápido e indolor que mostra se o coração está batendo normalmente. Fios no peito + braços + pernas. Detecta infarto e arritmias.' },
    { term: 'DPOC', simple: 'Doença Pulmonar Obstrutiva Crônica (pulmão destruído pelo cigarro)', detail: 'Doença crônica onde os pulmões perdem a capacidade de trocar ar. Causa: tabagismo. Sintomas: falta de ar progressiva, tosse crônica.' },
    { term: 'IC', simple: 'Insuficiência Cardíaca (coração fraco)', detail: 'O coração não bombeia sangue suficiente para o corpo. Causa cansaço, falta de ar, inchaço nas pernas.' },
    { term: 'FA', simple: 'Fibrilação Atrial (coração batendo irregular)', detail: 'Arritmia onde a parte de cima do coração treme desorganizadamente. Aumenta risco de AVC. Tratamento: controlar frequência + anticoagular.' },
    { term: 'PCR', simple: 'Parada Cardiorrespiratória (coração parou)', detail: 'O coração para de bater e a pessoa para de respirar. Sem RCP imediata, morte em minutos.' },
    { term: 'RCP', simple: 'Ressuscitação Cardiopulmonar (massagem cardíaca)', detail: 'Compressões no peito + respiração artificial para manter sangue circulando quando o coração para. Qualquer pessoa pode fazer.' },
    { term: 'FE', simple: 'Fração de Ejeção (força do coração em porcentagem)', detail: 'Quanto de sangue o coração ejeta a cada batida. Normal: > 55%. Abaixo de 40% = coração fraco (insuficiência cardíaca).' },
    { term: 'PA', simple: 'Pressão Arterial', detail: 'Força do sangue contra as paredes das artérias. Normal: 120/80 mmHg. Alta (HAS) > 140/90. Baixa (hipotensão) < 90/60.' },
    { term: 'HAS', simple: 'Hipertensão Arterial Sistêmica (pressão alta)', detail: 'Doença onde a pressão do sangue está cronicamente elevada. Fator de risco para infarto, AVC e doença renal. "Assassino silencioso".' },
    { term: 'DM', simple: 'Diabetes Mellitus (açúcar alto no sangue)', detail: 'Doença onde o corpo não produz ou não usa insulina adequadamente. Glicose se acumula no sangue e danifica órgãos ao longo do tempo.' },
    { term: 'ITU', simple: 'Infecção do Trato Urinário (infecção urinária)', detail: 'Bactérias no sistema urinário. Causa dor ao urinar, urgência e frequência. Mais comum em mulheres. Tratamento: antibiótico.' },
    { term: 'SNG', simple: 'Sonda Nasogástrica (tubo pelo nariz até o estômago)', detail: 'Tubo fino inserido pelo nariz que vai até o estômago. Usado para dar medicamentos, alimentar ou drenar conteúdo gástrico.' },
    { term: 'SF', simple: 'Soro Fisiológico (solução salina 0,9%)', detail: 'Água com sal na mesma concentração do sangue. Usado para hidratação IV, diluir medicamentos e lavar feridas.' },
    { term: 'CH', simple: 'Concentrado de Hemácias (bolsa de sangue)', detail: 'Sangue processado que contém apenas os glóbulos vermelhos. Usado em transfusões quando a hemoglobina está muito baixa.' },
    { term: 'PL', simple: 'Punção Lombar (colher líquido da coluna)', detail: 'Agulha nas costas (entre vértebras lombares) para colher líquido cefalorraquidiano. Diagnostica meningite, hemorragia cerebral.' },
    { term: 'TC', simple: 'Tomografia Computadorizada', detail: 'Exame de imagem que faz "fatias" do corpo com raios-X. Mais detalhado que Rx. Usado para ver cérebro, abdome, pulmão.' },
    { term: 'RM', simple: 'Ressonância Magnética', detail: 'Exame de imagem com ímã (sem radiação). Melhor que TC para cérebro, medula, articulações. Demora mais e é mais caro.' },
    { term: 'IV', simple: 'Intravenoso (na veia)', detail: 'Medicamento ou soro dado diretamente na veia por um cateter. Efeito mais rápido que comprimido.' },
    { term: 'IM', simple: 'Intramuscular (no músculo)', detail: 'Injeção aplicada no músculo (geralmente glúteo ou coxa). Absorção mais lenta que IV mas mais rápida que oral.' },
    { term: 'VO', simple: 'Via Oral (pela boca)', detail: 'Medicamento tomado pela boca (comprimido, cápsula, líquido). Forma mais comum de tomar remédio.' },
    { term: 'SC', simple: 'Subcutâneo (embaixo da pele)', detail: 'Injeção na gordura abaixo da pele. Usado para insulina, heparina, vacinas.' },
    { term: 'MgSO4', simple: 'Sulfato de Magnésio', detail: 'Medicamento usado para tratar/prevenir convulsões na eclâmpsia (gravidez) e como broncodilatador na asma grave.' },
    { term: 'NAC', simple: 'N-Acetilcisteína (antídoto do paracetamol)', detail: 'Medicamento que neutraliza o dano ao fígado causado por overdose de paracetamol. Dado na veia em protocolo de 21 horas.' },
    { term: 'BIA', simple: 'Balão Intra-Aórtico (bomba que ajuda o coração)', detail: 'Balão colocado na aorta que infla e desinfla com cada batimento, ajudando o coração fraco a bombear sangue. Usado em choque cardiogênico.' },
    { term: 'DOAC', simple: 'Anticoagulante Oral Direto (remédio que afina sangue)', detail: 'Nova geração de anticoagulantes (Rivaroxabana, Apixabana). Mais práticos que Warfarina — não precisam de exame de INR frequente.' },
    { term: 'INR', simple: 'Razão Normalizada Internacional (mede "afinamento" do sangue)', detail: 'Exame que mede se o sangue está "fino" o suficiente em quem toma Warfarina. Alvo normal: 2-3. Muito alto = risco de sangramento.' },
    { term: 'ATB', simple: 'Antibiótico', detail: 'Medicamento que mata ou impede o crescimento de bactérias. Não funciona contra vírus (gripe, COVID).' },
    { term: 'CTQ', simple: 'Centro de Tratamento de Queimados', detail: 'Hospital ou ala especializada no tratamento de grandes queimados. Possui equipe multidisciplinar e recursos específicos.' },
    { term: 'SCQ', simple: 'Superfície Corporal Queimada (% do corpo queimado)', detail: 'Porcentagem do corpo afetada pela queimadura. Calculada pela "regra dos 9". Acima de 20% = grande queimado (risco de vida).' },
    { term: 'CIVD', simple: 'Coagulação Intravascular Disseminada', detail: 'O sangue coagula descontroladamente dentro dos vasos, consumindo todas as plaquetas e fatores. Paradoxo: coagula E sangra ao mesmo tempo.' },
    { term: 'IRA', simple: 'Injúria Renal Aguda (rins parando de funcionar)', detail: 'Os rins param de filtrar o sangue em horas/dias. Causas: choque, medicamentos, obstrução. Pode precisar de diálise temporária.' },
    { term: 'EDA', simple: 'Endoscopia Digestiva Alta', detail: 'Exame com câmera pela boca para ver esôfago, estômago e duodeno. Diagnostica úlceras, varizes, tumores. Pode tratar sangramentos.' },
    { term: 'FAST', simple: 'USG rápida para ver sangue no abdome de trauma', detail: 'Ultrassom feito em 3 minutos na emergência para detectar sangue livre no abdome ou ao redor do coração em vítimas de trauma.' },
    { term: 'CTG', simple: 'Cardiotocografia (monitorar batimento do bebê)', detail: 'Exame que registra a frequência cardíaca do bebê dentro da barriga e as contrações da mãe durante o trabalho de parto.' },
    { term: 'BCF', simple: 'Batimentos Cardíacos Fetais (coração do bebê)', detail: 'Frequência cardíaca do bebê no útero. Normal: 110-160 bpm. Abaixo de 110 por tempo prolongado = sofrimento fetal.' }
];
